...
/**
 * Class EasyConfigEditForm.
 */
class EasyConfigEditForm extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['id'] = [
      '#type' => 'machine_name',
      '#default_value' => $entity->getConfigId(),
      '#machine_name' => [
  ...
  protected function actions(array $form, FormStateInterface $form_state) {
    ...
    $actions['submit']['#value'] = $this->t('Update config');
    $actions['delete']['#url'] = Url::fromRoute('entity.easy_config.delete_form', ['easy_config_type' => $this->easy_config_type, 'easy_config' => $this->entity->id()]);
    return $actions;
  }
